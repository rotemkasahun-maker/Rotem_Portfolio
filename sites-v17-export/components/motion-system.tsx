...
const groups = [
  [".golda-statement h1, .golda-statement h2, .golda-shift h2, .tiny-case-story h1, .about-opening h1, .ff-opening h1, .case106-opening h1, .case106-section h2", "headline"],
  [".golda-intro, .golda-shift-copy > p:last-child, .tiny-case-story > p, .ff-collect, .case106-intro, .case106-copy", "copy"],
  [".golda-role, .golda-lenses, .golda-index li, .golda-facts div, .golda-label, .tiny-case-label, .tiny-section-label, .about-opening > p, .ff-kicker, .case106-label, .case106-meta", "micro"],
  [".golda-lettuce, .golda-fridge, .tiny-main-product, .tiny-detail-product, .tiny-mobile-product, .ff-evidence, .ff-proof-wrap, .locked-page img, .case106-hero-evidence, .case106-secondary-evidence", "artifact"],
] as const;
